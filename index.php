        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="border-first-button"><a href="login1/">login</a></div></li> 
            </ul>        
            ...
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h2>inData</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae repudiandae eos reprehenderit perferendis facilis distinctio atque consectetur possimus veritatis, quibusdam placeat et iusto, ut officiis deserunt veniam aperiam! Animi, et.</p>
                  </div>
                  <div class="col-lg-12">
                    <div class="border-first-button scroll-to-section">
                      <a href="login1/">Pengajuan</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="" method="post">
            <div class="row">
              ...
              <div class="col-lg-5">
                <div id="map">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8263533663694!2d116.82543251374676!3d-1.2776699359747292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df147b882c0e52f%3A0x6e1fdde422e5beb8!2sDinas%20Komunikasi%20dan%20Informatika!5e0!3m2!1sid!2sid!4v1643191540146!5m2!1sid!2sid" width="100%" height="636px" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
              </div>
              <div class="col-lg-7">
                <div class="fill-form">
                    ...
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          ...
                          <a href="mailto:amat.roket123@gmail.com">our@email.com</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          ...
                          <a href="https://goo.gl/maps/21oisqqtDTTLW8nAA">123 Rio de Janeiro</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
