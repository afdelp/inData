                        ...
                        <div class="thumb">
                          <div class="row">
                            <div class="col-lg-6 align-self-center">
                                ...
                                <a href="crud_dalam/wl.php"><button type="button" class="btn btn-primary" >lihat data warga lokal</button></a>
                        ...
                        <div class="thumb">
                          <div class="row">
                            <div class="col-lg-6 align-self-center">
                                ...
                                <a href="crud_luar/wl.php"><button type="button" class="btn btn-primary" >lihat data warga dalam</button></a>
                            </div>
                          </div>
                        </div>
                      </div>
