...
$id = $_GET['id'];
include "../conf.php";
  $query_mysql = mysqli_query($conn,"SELECT * FROM kk_luar WHERE no_kk='$id'")or die(mysql_error());
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          ...
          <h4> Data Warga Domisili Luar  <em> RT 15 No <?php echo $i['no_rumah'];?></em></h4>
        ...
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s" class="table-responsive">
                ...
                <table  class="table table-hover ">
                    ...
                    <tbody>
                     ...
                     include "../conf.php";
                     $id = $_GET['id'];
                     $query_mysql = mysqli_query($conn,"SELECT * FROM warga_luar WHERE no_kk='$id'")or die(mysql_error());
                     $no = 1;
