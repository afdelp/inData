    ...
    <div class="container">
      ...
      <div class="col-lg-6 offset-lg-3">
          <div class="section-heading wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
            <h4>Tambah Data  Kartu Keluarga <em>Domisili Luar</em></h4>
            <div class="line-dec"></div>
          </div>
        </div>
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
      <form action="func_add.php" method="post">
        <div class="mb-3">
          <label for="nama" class="form-label">Nomor KK</label>
          <input type="text" class="form-control" name="no_kk" id="no_kk" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-label">Nama Kepala Keluarga</label>
          <input type="text" class="form-control" name="nama_kepala" id="nama_kepala">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-label">Nama Jalan</label>
          <input type="text" class="form-control" name="jalan" id="jalan" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-label">Nomor RT</label>
          <input type="text" class="form-control" name="no_rt" id="no_rt" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-label">Nomor Rumah</label>
          <input type="text" class="form-control" name="no_rumah" id="no_rumah" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-label">Nama Kelurahan</label>
          <input type="text" class="form-control" name="kelurahan" id="kelurahan" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-label">Nama Kecamatan</label>
          <input type="text" class="form-control" name="kecamatan" id="kecamatan" aria-describedby="emailHelp">
        </div>
