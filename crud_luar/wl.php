      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
            <h4>Data kartu keluarga  <em>domisili luar</em></h4>
        ...
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s" class="table-responsive">
                ...
                <table  class="table table-hover ">
                    ...
                    <?php
                      include '../conf.php';
                      $no = 1;
                      $data = mysqli_query($conn,"SELECT * from kk_luar");
                        ...
                        <div class="dropdown">
                          <button type="button" class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                              <li><a class="dropdown-item" href="detail_kk.php?id=<?= $d['no_kk'] ?>">anggota keluarga</a></li>
                              <li><a class="dropdown-item" href="detail_alamatluar.php?id=<?= $d['no_kk'] ?>">alamat kk luar</a></li>
                              <li><a class="dropdown-item" href="edit.php?id=<?= $d['no_kk'] ?>">edit</a></li>
                              <li><a class="dropdown-item" href="crud/delkk_luar.php?id=<?= $d['no_kk'] ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">hapus</a></li>
                            </ul>
                        </div>
                      </td>
                      <?php  }
